...
--------------------------------------------------------
  ...
  ALTER TABLE "MP1"."DEMO_TABLE1" ADD CONSTRAINT "DEMO_TABLE1_PK" PRIMARY KEY ("CUSTOMER_ID")  ENABLE;
  /
  ALTER TABLE "MP1"."DEMO_TABLE1" MODIFY ("CUSTOMER_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
/
  CREATE UNIQUE INDEX "MP1"."DEMO_TABLE2_PK" ON "MP1"."DEMO_TABLE2" ("PK") ;
--------------------------------------------------------
--  Constraints for Table DEMO_TABLE2
--------------------------------------------------------
/
  ALTER TABLE "MP1"."DEMO_TABLE2" ADD CONSTRAINT "DEMO_TABLE2_PK" PRIMARY KEY ("PK") ENABLE;
  /
  ALTER TABLE "MP1"."DEMO_TABLE2" MODIFY ("PK" NOT NULL ENABLE);
